...
Small React + TypeScript + Vite UI used in **code review** interviews. The goal is to **read** the code and note problems (bugs, risky patterns, maintainability)—not to implement large features in the session.
...
2. Review **`main`** and/or **open pull requests** in this repository (feature branches are listed as PRs).
